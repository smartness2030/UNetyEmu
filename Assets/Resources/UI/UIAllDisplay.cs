...
public class UIAllDisplay : MonoBehaviour
{
    ...
    private bool flagSimulationStart;
    ...
    void Update()
    {
        ...
        if (ObjectSetupPathPlanningScript.allInstantiatedObjectsReady == true && flagSimulationStart == false)
        {
            flagSimulationStart = true;
            startTime = Time.time;
        }

        // Set the value of the current time
        if (flagSimulationStart == true)
        {
