...
public class DroneInternalLogistics2 : MonoBehaviour
{
    ...
    private DroneSimpleCommunication droneCommunication;
    ...
    void Start()
    {
        ...
        // Get the DroneCommunication component
        droneCommunication = GetComponent<DroneSimpleCommunication>();
