...
// Class to control the animations of the big drone
public class Drone2Animation : MonoBehaviour
{
    ...
    // Animation features
    private Animator prefabDrone2Animation; // Animator component of the drone
    ...
    void Start()
    {
        ...
        prefabDrone2Animation = GetComponent<Animator>();
    ...
    void Update()
    {
        ...
        {
            if(prefabDrone2Animation != null) GetAnimationRotationSpeed();
        }
    ...
    void rotationPropellerSpeed(){
        ...
        prefabDrone2Animation.SetFloat("RotationSpeed", rotationSpeed);
    ...
    void deliverPackageAnimation(){
        ...
        prefabDrone2Animation.Play("PickUpPackageSS_1_2_Open", -1, -2.5f);
        prefabDrone2Animation.Play("PickUpPackageSS_1_3_Open", -1, -1.1f);
        prefabDrone2Animation.Play("PickUpPackageSS_1_4_Open", -1, -0.7f);
        prefabDrone2Animation.Play("PickUpPackageSS_1_5_Open", -1, -0.2f);
        prefabDrone2Animation.Play("PickUpPackageSS_1_6_Open", -1, 0f);

        // Set the animation time of the second package holder
        prefabDrone2Animation.Play("PickUpPackageSS_2_2_Open", -1, -2.5f);
        prefabDrone2Animation.Play("PickUpPackageSS_2_3_Open", -1, -1.1f);
        prefabDrone2Animation.Play("PickUpPackageSS_2_4_Open", -1, -0.7f);
        prefabDrone2Animation.Play("PickUpPackageSS_2_5_Open", -1, -0.2f);
        prefabDrone2Animation.Play("PickUpPackageSS_2_6_Open", -1, 0f);

        // Set the animation time of the third package holder
        prefabDrone2Animation.Play("PickUpPackageSS_3_2_Open", -1, -2.5f);
        prefabDrone2Animation.Play("PickUpPackageSS_3_3_Open", -1, -1.1f);
        prefabDrone2Animation.Play("PickUpPackageSS_3_4_Open", -1, -0.7f);
        prefabDrone2Animation.Play("PickUpPackageSS_3_5_Open", -1, -0.2f);
        prefabDrone2Animation.Play("PickUpPackageSS_3_6_Open", -1, 0f);

        // Set the animation time of the fourth package holder
        prefabDrone2Animation.Play("PickUpPackageSS_4_2_Open", -1, -2.5f);
        prefabDrone2Animation.Play("PickUpPackageSS_4_3_Open", -1, -1.1f);
        prefabDrone2Animation.Play("PickUpPackageSS_4_4_Open", -1, -0.7f);
        prefabDrone2Animation.Play("PickUpPackageSS_4_5_Open", -1, -0.2f);
        prefabDrone2Animation.Play("PickUpPackageSS_4_6_Open", -1, 0f);

        // Set the speed of the package holder animation
        prefabDrone2Animation.speed = packageHolderAnimationSpeed;

        // Set the trigger to open the package holder
        prefabDrone2Animation.SetTrigger("TrOpen");
    ...
    void pickUpPackageAnimation(){
        ...
        prefabDrone2Animation.SetTrigger("TrClose");
