...
LINUX_EXECUTABLE = "FirstScenarioLinux/FirstScenario.x86_64"
# LINUX_EXECUTABLE = "SecondScenarioLinux/SecondScenario.x86_64"
WINDOWS_EXECUTABLE = "FirstScenarioWindows/UNetyEmu.exe"
# WINDOWS_EXECUTABLE = "SecondScenarioWindows/UNetyEmu.exe"

# URLs of the release builds
LINUX_DOWNLOAD_URL = "https://github.com/intrig-unicamp/UNetyEmu/releases/download/sbrc25_s1_linux/FirstScenarioLinux.tar.gz"
# LINUX_DOWNLOAD_URL = "https://github.com/intrig-unicamp/UNetyEmu/releases/download/sbrc25_s2_linux/SecondScenarioLinux.tar.gz"
WINDOWS_DOWNLOAD_URL = "https://github.com/intrig-unicamp/UNetyEmu/releases/download/sbrc25_s1_windows/FirstScenarioWindows.zip"
# WINDOWS_DOWNLOAD_URL = "https://github.com/intrig-unicamp/UNetyEmu/releases/download/sbrc25_s2_windows/SecondScenarioWindows.zip"

# Archive names
LINUX_ARCHIVE = "FirstScenarioLinux.tar.gz"
# LINUX_ARCHIVE = "SecondScenarioLinux.tar.gz"
WINDOWS_ARCHIVE = "FirstScenarioWindows.zip"
# WINDOWS_ARCHIVE = "SecondScenarioWindows.zip"
